...
Test Run "Cart-Pole" Example
Q-Learning Algorithm
Function to display e.g. learned strategy or random strategy
...
class Q_Learning:
    ...
    def __init__(self,env,alpha,gamma,epsilon,numberEpisodes,numberOfBins,lowerBounds,upperBounds):
        ...
        #OpenAI environment
        self.env=env
        #step-size (how strong will rewards affect learning)
        self.alpha=alpha
        #discount rate for future Qs
        self.gamma=gamma 
        #probability of choosing the greedy solution (best Q) instead of a random option
        self.epsilon=epsilon 
        self.actionNumber=env.action_space.n 
        #number of episodes
        self.numberEpisodes=numberEpisodes
        #number of entrie per state (position, velocity, angle, angle velocity)
