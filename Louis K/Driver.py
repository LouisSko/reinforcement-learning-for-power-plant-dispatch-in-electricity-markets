...
How to run the class and set relevant parameters for env, q-learning
...
# run the Q-Learning algorithm // ACTUAL TRAINING!
Q1.simulateEpisodes()
# simulate the learned strategy (with greedy)
...
# now simulate a random strategy (without greedy)
