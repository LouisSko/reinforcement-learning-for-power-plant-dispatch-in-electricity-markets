...
class ActorCritic(nn.Module):
    def __init__(self, input_size, n_actions, n_neurons1=1024, n_neurons2=512, name='actor_critic',
    ...
    def forward(self, state):
        ...
        pi = self.softmax(self.fc_actor(value).reshape(24, -1))  # reshape output ant apply softmax for each row
