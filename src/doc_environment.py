...
# Defining the environment where the power plant operates
class market_env(gym.Env):
    ...
    # Defining a method that rescales the profit linearly.
    ...
    # Defining a method that rescales the profit linearly with a mc-bid_price approach.
    ...
    # Defining a method that rescales the profit logarithmically.
    ...
    # Defining a method that simulates a step in the environment.
    ...
    # Defining a method that simulates the market clearing.
    def market_clearing(self, bid_price, bid_volume, actual_price):
        ...
        #check if bid price under the actual market price
    ...
    # Defining a method that resets the environment.
    ...
    # Defining a method that returns a random new date.
